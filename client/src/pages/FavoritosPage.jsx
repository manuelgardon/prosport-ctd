...
export default function FavoritosPage() {
    ...
    useEffect(() => {
        async function cargarFavoritos() {
            try {
                const response = await axios.get('http://18.144.53.6:1234/api/user/favoritos', { withCredentials: true })
    ...
    async function eliminarFavorito(favorito) {
        try {
            const response = await axios.delete(`http://18.144.53.6:1234/api/favoritos/${favorito.espacioId._id}`, { withCredentials: true })
