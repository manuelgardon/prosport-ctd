...
export default function Calificacion({ espacioId, obtenerPromedio, obtenerCalificacion }) {
    ...
    async function obtenerCalificaciones() {
        try {
            const response = await axios.get(`https://strongly-secure-kiwi.ngrok-free.app/api/${espacioId}/calificaciones`)
            ...
            if(calificacion !== calificacionInicial || comentario !== comentarioInicial  ) {
                try {
                    const response = await axios.post(
                        'https://strongly-secure-kiwi.ngrok-free.app/api/calificaciones',
                        {
                            espacioId,
                            calificacion,
                            mensaje: comentario,
