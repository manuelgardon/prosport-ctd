...
export default function Reserva({ precio }) {
    ...
    useEffect(() => {
        async function obtenerReservaExistente() {
          try {
            const response = await axios.get(`https://strongly-secure-kiwi.ngrok-free.app/api/reservas?espacioId=${id}`);
        ...
        async function obtenerDiasDisponibles() {
          try {
            const response = await axios.get(`https://strongly-secure-kiwi.ngrok-free.app/api/espacios/${id}`);
        ...
        if (token) {
            ...
            try {
                ...
                const response = await axios.post(
                    'https://strongly-secure-kiwi.ngrok-free.app/api/reservas',
                    {
                        espacioId: id,
