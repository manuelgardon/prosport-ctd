                    ...
                    <section className="grid gap-2 grid-cols-[2fr_1fr] rounded-2xl overflow-hidden w-[500px]">
                        <div>
                            {favorito.espacioId?.fotos?.[0] && (
                                //foto principal
                                <img className="aspect-square object-cover cursor-pointer" src={`https://18.144.53.6:1234/${favorito.espacioId.fotos[0]}`} alt=''
                                />
                            )}
                        </div>
                        <div className="grid">
                            {favorito.espacioId?.fotos?.[1] && (
                                <img className="aspect-square object-cove cursor-pointer" src={`https://18.144.53.6:1234/${favorito.espacioId.fotos[1]}`} alt=""
                                />
                            )}
                            {favorito.espacioId?.fotos?.[2] && (
                                <img className="aspect-square object-cover cursor-pointer" src={`https://18.144.53.6:1234/${favorito.espacioId.fotos[2]}`} alt=""
                                />
                            )}
                        </div>
                    </section>
